namespace CursovaiUD
{
    ...
    "rity=True;Encrypt=False";
            ...
            // myCommand
            // 
            this.myCommand.CommandText = "SELECT * FROM GetMaterial()";
            ...
            this.Name = "ButtonMaterial";
            this.Text = "Список материалов";
            this.Load += new System.EventHandler(this.ButtonMaterial_Load);
